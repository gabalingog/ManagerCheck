    ...
    <div className='rateRestaurantPage'> 
      ...
      <div className="header">
        <div className="restaurantInfo">
          <span className="restaurantName">{restaurant?.name || restaurantName}</span>
          <p className="location">{restaurant?.location || 'Location'}</p>
          <div className="stars">
            {[1, 2, 3].map((star) => (
          ...
          <div className="reviewsList">
            {ratings.length === 0 ? (
              <div className="noReviews">
                <p>No reviews yet. Be the first to review {restaurant?.name || restaurantName}!</p>
              </div>
            ) : (
              <>
